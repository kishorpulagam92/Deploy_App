...
tpot_data = pd.read_csv('https://raw.githubusercontent.com/npulagam/Deploy_App/main/AirBnB/prepared_data.csv')
features = tpot_data.drop('target', axis=1)
training_features, testing_features, training_target, testing_target = \
            train_test_split(features, tpot_data['target'], random_state=None)

# Average CV score on the training set was: -49251.9588753509
exported_pipeline = DecisionTreeRegressor(max_depth=8, min_samples_leaf=6, min_samples_split=5)
...
title = 'AirBnB Price Prediction App'
encoder_location = 'https://github.com/npulagam/Deploy_App/blob/main/AirBnB/encoder.pkl?raw=true'
